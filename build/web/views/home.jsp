    ...
    <div class="grid product-grid">
        <article class="card product-card">
            <a href="${pageContext.request.contextPath}/product?id=p4444444-4444-4444-4444-444444444444">
                ...
                <div class="product-body"><span class="badge badge--sale">Bán chạy</span><h3 class="product-name">TP-Link Archer AX73 Wi-Fi 6</h3><span class="product-code">Mã: 44444444</span><strong class="price">2.890.000 VND</strong></div>
            </a>
        </article>
        <article class="card product-card">
            <a href="${pageContext.request.contextPath}/product?id=p3333333-3333-3333-3333-333333333333">
                ...
                <div class="product-body"><span class="badge badge--sale">Bán chạy</span><h3 class="product-name">Synology DiskStation DS923+</h3><span class="product-code">Mã: 33333333</span><strong class="price">16.890.000 VND</strong></div>
            </a>
        </article>
    </div>
</section>
