...
-- Categories: STORAGE_DEVICE, NETWORK_DEVICE
...
('p1000001-0000-0000-0000-000000000014', 'WD Black Performance HDD 3.5"', 'Ổ cứng HDD Western Digital Black hiệu năng cao 7200RPM, bộ nhớ đệm lớn, tối ưu hóa tốc độ tải game và các tác vụ xử lý đồ họa, chỉnh sửa video nặng.', 'b2222222-2222-2222-2222-222222222222', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
...
('p1000001-0000-0000-0000-000000000018', 'WD Black SN850X Gaming NVMe SSD', 'Ổ cứng SSD WD Black SN850X tốc độ cực khủng lên đến 7300MB/s, có tùy chọn heatsink tản nhiệt hầm hố, dòng SSD chuyên game hàng đầu cho PC và máy PS5.', 'b2222222-2222-2222-2222-222222222222', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
...
('p1000001-0000-0000-0000-000000000025', 'TP-Link Deco X50 Mesh Wi-Fi 6', 'Hệ thống Mesh Wi-Fi 6 TP-Link Deco X50 loại bỏ hoàn toàn vùng chết Wi-Fi trong nhà, tốc độ AX3000, quản lý thông minh qua ứng dụng Deco trực quan.', 'b4444444-4444-4444-4444-444444444444', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE'),
