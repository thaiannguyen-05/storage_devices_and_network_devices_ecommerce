...
INSERT INTO `Product` (`id`, `name`, `description`, `brandId`, `status`, `userId`, `category`)
VALUES
('p0000031-0000-0000-0000-000000000031', 'Samsung 980 SSD', 'M.2 NVMe SSD for everyday computing without heatsink.', 'b1111111-1111-1111-1111-111111111111', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
('p0000032-0000-0000-0000-000000000032', 'WD Purple Surveillance HDD', 'Optimized for 24/7 DVR and NVR surveillance systems.', 'b2222222-2222-2222-2222-222222222222', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
('p0000033-0000-0000-0000-000000000033', 'Synology DiskStation DS224+', '2-bay NAS for home and small office data management.', 'b3333333-3333-3333-3333-333333333333', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE'),
('p0000034-0000-0000-0000-000000000034', 'TP-Link Archer AXE75 Wi-Fi 6E Router', 'Tri-band Wi-Fi 6E router with 6 GHz band support.', 'b4444444-4444-4444-4444-444444444444', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE'),
('p0000035-0000-0000-0000-000000000035', 'SanDisk Ultra Dual Drive USB-C', 'Dual connector flash drive for phone and computer transfer.', 'b5555555-5555-5555-5555-555555555555', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'ACCESSORY'),
('p0000036-0000-0000-0000-000000000036', 'Samsung T9 Portable SSD', 'USB 3.2 Gen 2x2 portable SSD for high-speed content workflows.', 'b1111111-1111-1111-1111-111111111111', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
('p0000037-0000-0000-0000-000000000037', 'WD Black D10 Game Drive', 'Desktop HDD tuned for game library storage and fast load times.', 'b2222222-2222-2222-2222-222222222222', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
('p0000038-0000-0000-0000-000000000038', 'Synology DiskStation DS423+', '4-bay NAS with M.2 cache slots for performance storage.', 'b3333333-3333-3333-3333-333333333333', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE'),
('p0000039-0000-0000-0000-000000000039', 'TP-Link TL-SG105 Gigabit Switch', '5-port desktop unmanaged switch for quick network expansion.', 'b4444444-4444-4444-4444-444444444444', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE'),
('p0000040-0000-0000-0000-000000000040', 'SanDisk PRO-CINEMA CFexpress Card', 'Professional CFexpress Type B card for cinema cameras.', 'b5555555-5555-5555-5555-555555555555', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'ACCESSORY'),
('p0000041-0000-0000-0000-000000000041', 'Samsung Portable SSD T5', 'Slim portable SSD with metal body for everyday data transport.', 'b1111111-1111-1111-1111-111111111111', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
('p0000042-0000-0000-0000-000000000042', 'WD Red Pro NAS HDD', 'Enterprise-grade NAS hard drive for heavy workloads and RAID.', 'b2222222-2222-2222-2222-222222222222', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
('p0000043-0000-0000-0000-000000000043', 'Synology WRX560 Wi-Fi Router', 'Wi-Fi 6 router with SRM for centralized network management.', 'b3333333-3333-3333-3333-333333333333', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE'),
('p0000044-0000-0000-0000-000000000044', 'TP-Link Omada ER605 Router', 'Gigabit VPN router for Omada SDN business networks.', 'b4444444-4444-4444-4444-444444444444', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE'),
('p0000045-0000-0000-0000-000000000045', 'SanDisk iXpand Flash Drive', 'Lightning connector flash drive for iPhone and iPad backup.', 'b5555555-5555-5555-5555-555555555555', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'ACCESSORY'),
('p0000046-0000-0000-0000-000000000046', 'Samsung 9100 PRO NVMe SSD', 'Next-gen PCIe 5.0 NVMe SSD for extreme workstation performance.', 'b1111111-1111-1111-1111-111111111111', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
('p0000047-0000-0000-0000-000000000047', 'WD Gold Enterprise HDD', 'Data center class hard drive for enterprise server environments.', 'b2222222-2222-2222-2222-222222222222', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'STORAGE_DEVICE'),
('p0000048-0000-0000-0000-000000000048', 'Synology DiskStation DS1621+', '6-bay Ryzen-powered NAS for virtualization and heavy workloads.', 'b3333333-3333-3333-3333-333333333333', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE'),
('p0000049-0000-0000-0000-000000000049', 'TP-Link Archer GE810 Tri-Band Router', 'Gaming-optimized tri-band Wi-Fi 6 router with prioritized QoS.', 'b4444444-4444-4444-4444-444444444444', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE'),
('p0000050-0000-0000-0000-000000000050', 'SanDisk Extreme PRO SDXC UHS-II', 'Professional SD card for high-speed burst photography and 4K video.', 'b5555555-5555-5555-5555-555555555555', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'ACCESSORY'),
('p0000051-0000-0000-0000-000000000051', 'Samsung PRO Endurance microSD', 'High endurance microSD card designed for dashcams and CCTV.', 'b1111111-1111-1111-1111-111111111111', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'ACCESSORY'),
('p0000052-0000-0000-0000-000000000052', 'TP-Link Deco BE85 Mesh Wi-Fi 7', 'Next-gen Wi-Fi 7 mesh system with 10G ports for future-proof homes.', 'b4444444-4444-4444-4444-444444444444', 'ACTIVE', '11111111-1111-1111-1111-111111111111', 'NETWORK_DEVICE');
