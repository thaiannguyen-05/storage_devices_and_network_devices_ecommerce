...
<html>
    <head>
        ...
        <title>Thanh toán | LinhNamStore</title>
    ...
    <body>
        ...
        <header class="home-header">
            <div class="home-header-top">
                ...
                <div class="home-header-right">
                    <a class="home-category-btn" href="${pageContext.request.contextPath}/product">Quay lại cửa hàng</a>
                </div>
            </div>
        </header>
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/payment">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                            <div class="ch-form-field">
                                ...
                                <input name="phone" required placeholder="+84 9xx">
                            </div>
                            <div class="ch-form-field">
                                <label>Email</label>
                        ...
                        <div class="ch-form-field">
                            ...
                            <textarea name="address" required style="min-height: 80px;"></textarea>
                        </div>
                        <div class="ch-form-field">
                            <label>Tỉnh / Thành phố</label>
                            <input name="city" required placeholder="TP. Hồ Chí Minh">
                        </div>
                        <div class="ch-form-field">
                        ...
                        <div id="cardPaymentBox" style="display: none; background: var(--ch-surface-soft); padding: 16px; border-radius: 8px; margin-bottom: 24px; border: 1px solid var(--ch-hairline);">
                            <div class="ch-form-field">
                                ...
                                <input id="cardHolder" name="cardHolder" placeholder="NGUYEN VAN A">
                            </div>
                            <div class="ch-form-field">
                                <label>Số thẻ</label>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                                ...
                                <div class="ch-form-field">
                                    <label>Mã CVC</label>
                                    <input id="cardCvv" name="cardCvv" placeholder="123">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="summary-line">
                            <span>TẠM TÍNH</span>
                            <span><%= subtotalText == null ? "0 VND" : subtotalText %></span>
                        </div>
                        <div class="summary-line">
                        ...
                        <div class="summary-line">
                            <span>GIẢM GIÁ</span>
                            <span style="color: var(--ch-primary);"><%= discountText == null ? "-0 VND" : discountText %></span>
                        </div>
                        <div class="summary-line total">
                            <span>TỔNG CỘNG</span>
                            <span><%= totalPriceText == null ? "0 VND" : totalPriceText %></span>
                        </div>
        ...
        <script>
            ...
            (function () {
                ...
                function isCardMethod(value) {
                    return value === "VISA" || value === "ATM";
                }

                function toggleCardFields() {
                    var show = isCardMethod(methodEl.value);
                ...
                methodEl.addEventListener("change", toggleCardFields);
                toggleCardFields();
            })();
        </script>
    </body>
