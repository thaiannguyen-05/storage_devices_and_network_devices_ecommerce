<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Thanh toán thành công | LinhNamStore</title>
    ...
    <body>
        ...
        <main class="home-main" style="min-height:72vh;display:flex;align-items:center;justify-content:center;">
            <section class="summary-card" style="max-width:680px;width:100%;text-align:center;padding:42px 28px;">
                <div
                    style="width:96px;height:96px;border-radius:50%;background:rgba(22,163,74,.16);border:2px solid rgba(22,163,74,.45);display:flex;align-items:center;justify-content:center;margin:0 auto 18px;box-shadow:0 0 28px rgba(22,163,74,.22);">
                    <svg width="52" height="52" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                        <path d="M20 6 9 17l-5-5" stroke="#4ade80" stroke-width="2.8" stroke-linecap="round"
