...
<html>
    <head>
        ...
        <title>Profile | LinhNamStore</title>
        ...
        <style>
            ...
            .profile-avatar {
                ...
                align-items: center;
                justify-content: center;
                background: linear-gradient(145deg, #12326f, #0a0f1f);
                color: #faff69;
                font-size: 48px;
                font-weight: 800;
            ...
            .profile-info-pane {
                flex: 1;
                padding: 38px 38px 34px 16px;
                display: flex;
                flex-direction: column;
                justify-content: center;
                animation: profileInfoFade 0.45s ease 0.18s both;
            }
            ...
            @keyframes profileExpand {
                from {
                    opacity: 0;
                    transform: scaleX(0.2) translateY(12px);
                }
                to {
                    opacity: 1;
                    ...
                    <section class="profile-card">
                        <div class="profile-avatar-pane">
                            ...
                            <div class="profile-avatar-meta">
                                ...
                                <h2><%= profileName %></h2>
                                <p><%= user.getEmail() == null ? "No email available" : user.getEmail() %></p>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-pane">
                            ...
                            <div class="profile-grid">
                                ...
                                <div class="profile-field">
                                    <span>Email</span>
                                    <strong><%= user.getEmail() == null ? "-" : user.getEmail() %></strong>
                                </div>
                                <div class="profile-field">
                                    <span>Ngày sinh</span>
                                    <strong><%= user.getDateOfBirth() == null ? "-" : user.getDateOfBirth().format(dateFormatter) %></strong>
                                </div>
                                <div class="profile-field">
                                    <span>Trạng thái</span>
                                    <strong><%= user.getStatus() == null ? "-" : user.getStatus() %></strong>
                                </div>
                                <div class="profile-field">
                                    <span>Vai trò</span>
                                    <strong><%= user.getRole() == null ? "-" : user.getRole() %></strong>
                                </div>
                                <div class="profile-field">
                                    <span>Tạo lúc</span>
                                    <strong><%= user.getCreatedAt() == null ? "-" : user.getCreatedAt().format(dateTimeFormatter) %></strong>
                                </div>
                                <div class="profile-field">
                                    <span>Cập nhật lúc</span>
                                    <strong><%= user.getUpdatedAt() == null ? "-" : user.getUpdatedAt().format(dateTimeFormatter) %></strong>
                                </div>
                            </div>
