            ...
            <div class="auth-card">
                ...
                <form action="${pageContext.request.contextPath}/auth?action=signup" method="post">
                    ...
                    <div class="ch-form-field">
                        ...
                        <input type="date" name="dateOfBirth" required value="<%= request.getAttribute("dateOfBirth") == null ? "" : request.getAttribute("dateOfBirth") %>">
                        <p style="margin:6px 0 0;font-size:12px;opacity:.8;">Bạn phải từ 18 tuổi trở lên.</p>
                    </div>
